...
def save_npz_data(data_path, x_train, x_test, y_train, train_ids, test_ids):
    """
    This function saves the data in a npz file.
...
def load_feature_names(data_path):
    ...
    """
    csv_path = os.path.join(data_path, "x_train.csv")
...
def split_data(x, y, ratio, seed=1):
    ...
    split_index = int(np.floor(n_samples * ratio))
